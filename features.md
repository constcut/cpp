...
Заполнить из: https://en.wikibooks.org/wiki/More_C%2B%2B_Idioms/Non-copyable_Mixin
...
При чтении данных используется общий объект, а при изменении - создаётся новый.

TODO расширить примером кода.
